...
STAGES: dict[str, StageSpec] = {
    "discover": StageSpec(
        ...
        checklist=(
            ...
            ("throughput_surfaces", "Identify which metadata/API routes and file-download routes should be benchmarked for real throughput."),
    ...
    "feasibility": StageSpec(
        ...
        checklist=(
            ...
            ("throughput_benchmark", "Benchmark metadata/API speed and file-download speed conservatively enough to estimate sustained throughput."),
            ("download_eta", "Estimate total-corpus ETA from recent throughput data and viable parallelism."),
    ...
    "adapter_spec": StageSpec(
        ...
        checklist=(
            ...
            ("download_telemetry", "Define rolling throughput logging, ETA calculation, and per-request logging fields."),
            ("investigation_trigger", "Define when slow throughput should trigger a Codex investigation and what evidence it should receive."),
    ...
    "build_scraper": StageSpec(
        ...
        checklist=(
            ...
            ("download_telemetry", "Integrate rolling download metrics, ETA reporting, and request logging."),
            ("investigation_trigger", "Integrate the slow-throughput investigation trigger hook."),
    ...
    "smoke_test_scraper": StageSpec(
        ...
        checklist=(
            ...
            ("throughput_logging", "Emit request logs and a rolling throughput snapshot during the smoke test."),
            ("eta_snapshot", "Produce an ETA snapshot and threshold-breach result from the recent metrics."),
